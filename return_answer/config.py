...
semantic_slot = {
    "disease": {
        "slot_list": ["disease"],
        "slot_values": None,
        "cql_template": ["MATCH(p:疾病)-[r:has_symptom]->(q:症状) WHERE q.name='{disease}' RETURN p.name",
                        "MATCH(p:疾病)-[r:has_alias]->(q:别名) WHERE q.name='{disease}' RETURN p.name"
                         ],
    ...
    "drug": {
        "slot_list": ["drug"],
        "slot_values": None,
        "cql_template": "MATCH(p:疾病)-[r:has_common_drug]->(q:药品) WHERE q.name='{drug}' RETURN p.name",
        "reply_template": "'{Disease}' 是这样的：\n",
        "ask_template": "您问的是 '{Disease}' 的定义吗？",
        "intent_strategy": "",
        "deny_response": "很抱歉没有理解你的意思呢~"
    ...
    "feature": {
        "slot_list": ["feature"],
        "slot_values": None,
        "cql_template": "MATCH(p:疾病)-[r:has_symptom]->(q:症状) WHERE q.name='{feature}' RETURN p.name",
        "reply_template": "'{Disease}' 是这样的：\n",
        "ask_template": "您问的是 '{Disease}' 的定义吗？",
        "intent_strategy": "",
        "deny_response": "很抱歉没有理解你的意思呢~"
    ...
    "symptom": {
        "slot_list": ["symptom"],
        "slot_values": None,
        "cql_template": "MATCH(p:疾病)-[r:has_symptom]->(q:症状) WHERE q.name='{symptom}' RETURN p.name",
        "reply_template": "'{Disease}' 是这样的：\n",
        "ask_template": "您问的是 '{Disease}' 的定义吗？",
        "intent_strategy": "",
        "deny_response": "很抱歉没有理解你的意思呢~"
    ...
    "body": {
        "slot_list": ["body"],
        "slot_values": None,
        "cql_template": "MATCH(p:疾病)-[r:in_body]->(q:身体) WHERE q.name='{body}' RETURN p.name",
        "reply_template": "'{Disease}' 是这样的：\n",
        "ask_template": "您问的是 '{Disease}' 的定义吗？",
        "intent_strategy": "",
        "deny_response": "很抱歉没有理解你的意思呢~"
    ...
    "test": {
        "slot_list": ["test"],
        "slot_values": None,
        "cql_template": "MATCH(p:疾病)-[r:need_check]->(q:检查) WHERE q.name='{test}' RETURN p.name",
        "reply_template": "'{Disease}' 是这样的：\n",
        "ask_template": "您问的是 '{Disease}' 的定义吗？",
        "intent_strategy": "",
        "deny_response": "很抱歉没有理解你的意思呢~"
    ...
    "department": {
            "slot_list": ["test"],
            "slot_values": None,
            "cql_template": "MATCH(p:疾病)-[r:cure_department]->(q:科室) WHERE q.name='{department}' RETURN p.name",
            "reply_template": "'{Disease}' 是这样的：\n",
            "ask_template": "您问的是 '{Disease}' 的定义吗？",
            "intent_strategy": "",
            "deny_response": "很抱歉没有理解你的意思呢~"
